...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: LIST plugboard_config, STRING char, LIST rotors, LIST_3*INTEGER offsets
...
def machine_cycle(plugboard_config, char, rotors, offsets):
    ...
    char_reflector = reflector(char_rotors_in)
...
Method: encrypt_char()
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: LIST list_text, LIST plugboard_config, LIST rotors, LIST_3*INTEGER offsets, INTEGER i
OUTPUT: STRING coded_char
FUNCTIONALITY:
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_plug_in, LIST rotors, LIST_3*INTEGER offsets
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_plug_in, LIST list_f_rotor
OUTPUT: STRING char_f_rotor
FUNCTIONALITY:
- Runs the character from the plugboard through the fast rotor.
- This method collects the position of the character in the alphabet and finds the character
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_f_rot, LIST list_m_rotor
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_m_rot, LIST list_s_rotor
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_reflector, LIST rotors, LIST_3*INTEGER offsets
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_reflector, LIST list_s_rotor
OUTPUT: STRING char_s_rotor
FUNCTIONALITY:
- Runs the character from the reflector through the slow rotor.
- This method collects the position of the character in the slow rotor and finds the character
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_s_rot, LIST list_m_rotor
OUTPUT: STRING char_m_rotor
FUNCTIONALITY:
- Runs the character from the slow rotor through the medium rotor.
- This method collects the position of the character in the medium rotor and finds the character
that connects with the index in the alphabet.
"""
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
INPUT: INTEGER index_c_m_rot, LIST list_f_rotor
OUTPUT: STRING char_f_rotor
FUNCTIONALITY:
- Runs the character from the medium rotor through the fast rotor.
- This method collects the position of the character in the fast rotor and finds the character
that connects with the index in the alphabet.
"""
